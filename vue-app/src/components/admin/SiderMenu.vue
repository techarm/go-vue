<template>
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <router-link class="navbar-brand m-0" to="/admin" target="_blank">
                <img src="/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
                <span class="ms-1 font-weight-bold text-white">Teacharm Dashboard</span>
            </router-link>
        </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <router-link class="nav-link text-white" :class="{'active bg-gradient-primary' : selectedMenu === 'bookAdd'}" to="/admin/books/0">
                        ...
                        <span class="nav-link-text ms-1">書籍登録</span>
                    </router-link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link text-white" :class="{'active bg-gradient-primary' : selectedMenu === 'bookList'}" to="/admin/books">
                        ...
                        <span class="nav-link-text ms-1">書籍一覧</span>
                    </router-link>
                </li>
                <li class="nav-item mt-3">
                ...
                <li class="nav-item">
                    <router-link class="nav-link text-white" :class="{'active bg-gradient-primary' : selectedMenu === 'userAdd'}" to="/admin/users/0">
                        ...
                        <span class="nav-link-text ms-1">ユーザー登録</span>
                    </router-link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link text-white" :class="{'active bg-gradient-primary' : selectedMenu === 'userList'}" to="/admin/users">
                        ...
                        <span class="nav-link-text ms-1">ユーザー一覧</span>
                    </router-link>
                </li>
            </ul>
        </div>
